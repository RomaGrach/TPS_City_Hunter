...
namespace FluffyUnderware.Curvy.Examples
{
    ...
    public class E01_MetaDataController : SplineController
    {
        ...
        void setHeight()
        {
            ...
            if (TargetComponent != Controllers.TargetComponent.Transform)
                throw new NotSupportedException($"Only controllers with {nameof(TargetComponent)} set to {Controllers.TargetComponent.Transform} are supported");

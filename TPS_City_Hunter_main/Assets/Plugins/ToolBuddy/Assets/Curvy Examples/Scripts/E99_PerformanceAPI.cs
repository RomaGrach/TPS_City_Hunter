...
namespace FluffyUnderware.Curvy.Examples
{
    ...
    {
        const int LOOPS = 20;
        readonly List<string> mTests = new List<string>();
        readonly List<string> mTestResults = new List<string>();
        ...
        int mCurrentTest = -1;
        bool mExecuting;
        readonly TimeMeasure Timer = new TimeMeasure(LOOPS);
